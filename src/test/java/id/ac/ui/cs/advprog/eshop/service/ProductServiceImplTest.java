...
class ProductServiceImplTest {
    ...
    @Test
    void testEdit() {
        when(productRepository.edit(any(Product.class), anyString())).thenReturn(sampleProduct);
        ...
        verify(productRepository, times(1)).edit(sampleProduct, "12345");
    }

    @Test
    void testDelete() {
        when(productRepository.delete(anyString())).thenReturn(sampleProduct);
    ...
    @Test
    void testFindById() {
        when(productRepository.findById(anyString())).thenReturn(sampleProduct);
